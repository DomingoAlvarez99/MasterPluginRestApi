...
public class PlayerController {
	...
	@GetMapping("/players/getByFirstLogin/{firstLogin}")
	public ResponseEntity<List<PlayerModel>> getByFirstLogin(@PathVariable("firstLogin") Calendar firstLogin) {
		return new ResponseEntity<>(service.getByFirstLogin(firstLogin), HttpStatus.OK);
	}
	...
	@GetMapping("/players/getByLastLogin/{lastLogin}")
	public ResponseEntity<List<PlayerModel>> getByLastLogin(@PathVariable("lastLogin") Calendar lastLogin) {
		return new ResponseEntity<>(service.getByLastLogin(lastLogin), HttpStatus.OK);
	}
